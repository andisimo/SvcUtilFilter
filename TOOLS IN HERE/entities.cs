...
namespace CrmClasses
{
	...
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "5.0.9690.3339")]
	public partial class ProxyService : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		
		/// <summary>
		/// Constructor.
		/// </summary>
		public ProxyService(Microsoft.Xrm.Sdk.IOrganizationService service) : 
				base(service)
		{
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="CrmClasses.Annotation"/> entities.
		/// </summary>
		public System.Linq.IQueryable<CrmClasses.Annotation> AnnotationSet
		{
			get
			{
				return this.CreateQuery<CrmClasses.Annotation>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="CrmClasses.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<CrmClasses.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<CrmClasses.Contact>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="CrmClasses.SystemUser"/> entities.
		/// </summary>
		public System.Linq.IQueryable<CrmClasses.SystemUser> SystemUserSet
		{
			get
			{
				return this.CreateQuery<CrmClasses.SystemUser>();
			}
		}
	}
}
